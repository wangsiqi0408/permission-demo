...
<!-- text fonts -->
<link rel="stylesheet" href="${APP_PATH}/static/assets/css/google-fonts.css"/>
<!-- ace styles -->
<link rel="stylesheet" href="${APP_PATH}/static/assets/css/ace.min.css"/>
<!--[if lte IE 9]>
<link rel="stylesheet" href="${APP_PATH}/static/assets/css/ace-part2.min.css"/>
<![endif]-->
...
<link rel="stylesheet" href="${APP_PATH}/static/assets/css/jquery.gritter.css" />
<link rel="stylesheet" href="${APP_PATH}/static/assets/css/jquery-ui.min.css" />
<link rel="stylesheet" href="${APP_PATH}/static/assets/css/chosen.css" />
<!--[if lte IE 9]>
...
<script src="${APP_PATH}/static/assets/js/jquery-ui.min.js"></script>
<script src="${APP_PATH}/static/assets/js/jquery.gritter.min.js"></script>
<script src="${APP_PATH}/static/assets/js/chosen.jquery.min.js"></script>
<script src="http://cdn.bootcss.com/mustache.js/2.2.1/mustache.js"></script>
<script src="${APP_PATH}/static/bootstrap3.3.5/js/bootstrap.min.js"></script>
